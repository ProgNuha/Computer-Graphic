...
void createFlower(Point center, Point r,Point r1){
	Point t1;
	void flowerPoint(int xCenter, int yCenter, int x, int y,Point r);
	t1 = ownRotate1(center.x,center.y,r.x,r.y,45);
	line(r.x,r.y,t1.x,t1.y);
	t1 = ownRotate1(center.x,center.y,r.x,r.y,90);
	line(r.x,r.y,t1.x,t1.y);
	t1 = ownRotate1(center.x,center.y,r.x,r.y,135);
	line(r.x,r.y,t1.x,t1.y);
	t1 = ownRotate1(center.x,center.y,r.x,r.y,180);
	line(r.x,r.y,t1.x,t1.y);
	t1 = ownRotate1(center.x,center.y,r.x,r.y,225);
	line(r.x,r.y,t1.x,t1.y);
	t1 = ownRotate1(center.x,center.y,r.x,r.y,270);
	line(r.x,r.y,t1.x,t1.y);
	t1 = ownRotate1(center.x,center.y,r.x,r.y,315);
//	t1 = ownRotate1(center.x,center.y,r.x,r.y,);
//	t1 = ownRotate1(center.x,center.y,r.x,r.y,90);
//	ellipseMidpoint(t1.x, t1.y,r1.x,r1.y);
...
void flowerPoint(int xCenter, int yCenter, int x, int y,Point r){
	int Color = 3;
	Point t1;
	t1 = ownRotate1(xCenter + x,yCenter + y,r.x,r.y,45);
	putpixel(t1.x,t1.y, Color);
	putpixel(xCenter - x, yCenter + y, Color);
	Color = 5;
	putpixel(xCenter + x, yCenter - y, Color);
	putpixel(xCenter - x, yCenter - y, Color);
