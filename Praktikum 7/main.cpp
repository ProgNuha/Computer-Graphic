...
//	// Pumpkin orange
////	glClearColor(0.98f, 0.625f, 0.12f, 0.0f); 
//	// Pastel pink
////	glClearColor(0.98f, 0.4f, 0.7f, 0.0f); 
//	// Barney purple
////	glClearColor(0.60f, 0.40f, 0.70f, 0.0f); 
//}
//
//void draw_line(){
//	glBegin(GL_LINES);
...
//      glVertex3f(250,250, 0.0f);
//      glVertex3f(350,250, 0.0f);
//	glEnd();
//}
//
//void displayLine(){
...
void reshape(GLsizei width, GLsizei height) {  // GLsizei for non-negative integer
   ...
   gluPerspective(45.0f, aspect, 0.1f, 0.0f);
}
